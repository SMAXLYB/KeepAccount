...
//                     binding.tvMoney.setTextColor(getColorById(R.color.common_income))
//                     "收入"
//                 } else {
//                     binding.tvMoney.setTextColor(getColorById(R.color.common_outcome))
//                     "支出"
//                 }
...
//         data: List<T>,
//         bindView: (CommonBottomSheetRecyclerviewItebinding, T) -> Unit,
//         listener: (CommonBottomSheetRecyclerviewItebinding, T, Int) -> Unit,
//     ) {
//         val dialog = BottomSheetDialog(this, R.style.CommonBottomSheetDialog).apply {
//             val binding = CommonBottomSheetRecyclerviewBinding.inflate(layoutInflater).apply {
//                 rvContent.layoutManager =
//                     LinearLayoutManager(this@EditRecordFragment, RecyclerView.VERTICAL, false)
//                 rvContent.adapter =
//                     object : BaseAdapter<T, CommonBottomSheetRecyclerviewItebinding>(
//                         data
//                     ) {
...
//                             binding: CommonBottomSheetRecyclerviewItebinding,
//                             itemData: T,
//                         ) {
