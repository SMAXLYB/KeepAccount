...
import life.chenshi.keepaccounts.module.setting.databinding.SettingLayoutCategoryBinding
...
class CategoryActivity : BaseActivity() {
    ...
    private val mBinding by bindingContentView<SettingLayoutCategoryBinding>(R.layout.setting_layout_category)
        ...
        mCategoryViewModel.apply {
            ...
            business.observe(this@CategoryActivity) {
                it?.run {
                    ...
                    mBinding.bar.setRightIcon(
                        AppCompatResources.getDrawable(
                            this@CategoryActivity,
                            R.drawable.common_action_bar_complete
                        )!!
                    )
                }
            }
