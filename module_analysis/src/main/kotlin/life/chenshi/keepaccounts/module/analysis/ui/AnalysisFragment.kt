...
import life.chenshi.keepaccounts.module.analysis.R
import life.chenshi.keepaccounts.module.analysis.adapter.AnalyzeProportionAdapter
import life.chenshi.keepaccounts.module.analysis.databinding.AnalysisFragmentAnaylzeBinding
import life.chenshi.keepaccounts.module.analysis.view.MyMarkerView
import life.chenshi.keepaccounts.module.analysis.vm.AnalyzeViewModel
...
class AnalysisFragment : Fragment() {
    ...
    private lateinit var mBinding: AnalysisFragmentAnaylzeBinding
    ...
    override fun onCreateView(
        ...
        mBinding =
            DataBindingUtil.inflate(inflater, R.layout.analysis_fragment_anaylze, container, false)
    ...
    private fun initView() {
        ...
        mBinding.lineChart.apply {
            ...
            marker =
                MyMarkerView(TYPE_MONTH, requireActivity(), R.layout.analysis_layout_analyze_marker)
            setNoDataText("暂无数据")
